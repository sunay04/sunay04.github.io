...
export function EditorPage() {
  ...
  return <main className="editor-shell">
    <header className="editor-topbar liquid-glass-strong">
      <div className="editor-brand"><a href="/" aria-label="返回作品集">S</a><div><span>Sunay's Portfolio</span><small>{session.user?.repository}</small></div></div>
